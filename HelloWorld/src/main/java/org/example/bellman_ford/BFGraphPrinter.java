 ...
 */
public class BFGraphPrinter extends GraphObserver {
	 ...
	 */
	public BFGraphPrinter(String prefix) {
		super(prefix);
	...
	public boolean execute() {
        ...
        try {
            ...
            for (int i=0; i < n ; i++) {
                ...
                BellmanFordProtocol protocol = (BellmanFordProtocol)Network.get(i).getProtocol(pid);
