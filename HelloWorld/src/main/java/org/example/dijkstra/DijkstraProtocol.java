 ...
 */
public class DijkstraProtocol implements CDProtocol {
     ...
     */
    public DijkstraProtocol(@SuppressWarnings("unused") String prefix) {
        /* Start in INIT phase */
    ...
    private void broadcast(int pid) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            DijkstraProtocol tempProtocol = (DijkstraProtocol) tempNode.getProtocol(pid);
            /* Copy local graph */
