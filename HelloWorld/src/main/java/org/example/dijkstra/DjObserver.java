 ...
 */
public class DjObserver implements Control{
	 ...
	 */
	public DjObserver(String prefix) {
	...
	public boolean execute() {
		for(int i=0; i < Network.size(); i++ ) {										//for each node in network
			...
			DijkstraProtocol protocol = (DijkstraProtocol) node.getProtocol(pid);	//get DV protocol
