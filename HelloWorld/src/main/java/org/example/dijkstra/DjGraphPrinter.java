 ...
 */
public class DjGraphPrinter extends GraphObserver {
	 ...
	 */
	public DjGraphPrinter(String prefix) {
		super(prefix);
	...
	public boolean execute() {
        ...
        try {
            ...
            for (int i=0; i < n ; i++) {
                ...
                DijkstraProtocol protocol = (DijkstraProtocol)Network.get(i).getProtocol(pid);
