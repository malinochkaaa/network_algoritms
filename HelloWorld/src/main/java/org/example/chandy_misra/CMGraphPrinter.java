 ...
 */
public class CMGraphPrinter extends GraphObserver {
	 ...
	 */
	public CMGraphPrinter(String prefix) {
		super(prefix);
	...
	public boolean execute() {
        ...
        try {
            ...
            for (int i=0; i < n ; i++) {
                ...
                ChandyMisraProtocol protocol = (ChandyMisraProtocol)Network.get(i).getProtocol(pid);
