 ...
 */
public class CMObserver implements Control{
	 ...
	 */
	public CMObserver(String prefix) {
	...
	public boolean execute() {
		for(int i=0; i < Network.size(); i++ ) {										//for each node in network
			...
			ChandyMisraProtocol protocol = (ChandyMisraProtocol) node.getProtocol(pid);	//get DV protocol
